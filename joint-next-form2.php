...
if (isset($_POST['submit'])) {
    ...
    // image file 2
    $auth_imgFileSize2 = $_FILES['auth_sign_2']['size'];
    $auth_imgFileType2 = $_FILES['auth_sign_2']['type'];
    $auth_imgFileName2 = $_FILES['auth_sign_2']['name'];
    if ($auth_imgFileSize2 <= 1000000) {
        if (
            $auth_imgFileType === 'image/jpeg' ||
            $auth_imgFileType === 'image/jpg' ||
            $auth_imgFileType === 'image/png' ||
            ...
            $auth_imgTarget2 =
                'account-opening/' . basename($_FILES['auth_sign_2']['name']);
        } else {
            $fileTypeErr = 'Only jpeg, jpg, png and pdf is allowed';
            $auth_imgTarget2 = 'Error';
        }
    } else {
        $fileSizeErr = 'File size is bigger than allowed size';
    }
    ...
    if (
        move_uploaded_file($_FILES['auth_sign_2']['tmp_name'], $auth_imgTarget2)
    ) {
    } else {
        $upErr = 'document failed to upload. Try again!';
    }
    ...
    $auth_sign_2 = $_FILES['auth_sign_2']['name'];
...
<body>
    ...
    <div class="container py-5">
        ...
        <form action="joint-next-form3.php" method="post" enctype="multipart/form-data">
            <div class="row mb-3">
                <div class="row mb-3">
            ...
            <div class="row mb-3">
                <div class="row mb-3">
                    <div class="form-group col-md-6">
                        <label for="" class="fs-4">Next of Kin's Name: <sup>2*</sup></label>
                        <input type="text" name="next_kin_2" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="" class="fs-4">Relationship: <sup>2*</sup></label>
                        <input type="text" name="relationship_2" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="form-group col-md-6">
                        <label for="" class="fs-4">Next of Kin's Phone Number: <sup>2*</sup></label>
                        <input type="text" name="next_kin_phone_2" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="" class="fs-4">Address: <sup>2*</sup></label>
                        <input type="text" name="next_address_2" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="next_busstop_2" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                </div>
