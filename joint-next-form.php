...
<body>
    ...
    <div class="container py-5">
        <div class="mb-5">
            <h2 class="pry-comp-text text-capitalize mb-3 fw-bold">Occupation details</h2>
            <div class="title-line" style="width: 40px; height: 6px; background: #a5d4ce; border-radius: 3px;"></div>
        </div>
        <form action="joint-next-form2.php" method="post" enctype="multipart/form-data">
            <div class="row mb-3">
                <div class="row mb-3">
                    <div class="form-group col-md-6">
                        <label for="" class="fs-4">Occupation: <sup>*</sup></label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="" class="fs-4">Employer Name: <sup>*</sup></label>
                        <input type="text" name="employer_name" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="form-group col-md-3">
                        <label for="" class="fs-4">Source of Fund: <sup>*</sup></label>
                        <select class="form-select" name="source_fund" id="" required>
                    ...
                    <div class="form-group col-md-3">
                        <label for="" class="fs-4">Other Source of Fund: <sup>*</sup></label>
                        <input type="text" name="other_fund" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6"></small>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="" class="fs-4">Estimated Annual Income: <sup>*</sup></label>
                        <input type="text" name="estimated_income" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="form-group col-md-12">
                        <label for="" class="fs-4">Authorized Signature:</label>
                        <input type="file" name="auth_sign" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                <div class="row mb-3">
                    <div class="form-group col-md-6">
                        <label for="" class="fs-4">Occupation: <sup>2*</sup></label>
                        <input type="text" name="occupation_2" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="" class="fs-4">Employer Name: <sup>2*</sup></label>
                        <input type="text" name="employer_name_2" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="form-group col-md-3">
                        <label for="" class="fs-4">Source of Fund: <sup>2*</sup></label>
                        <select class="form-select" name="source_fund_2" id="" required>
                            <option value="Salary">Salary</option>
                            <option value="Funding">Funding</option>
                            <option value="Loan">Loan</option>
                            <option value="Others">Others</option>
                    ...
                    <div class="form-group col-md-3">
                        <label for="" class="fs-4">Other Source of Fund: <sup>2*</sup></label>
                        <input type="text" name="other_fund_2" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6"></small>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="" class="fs-4">Estimated Annual Income: <sup>2*</sup></label>
                        <input type="text" name="estimated_income_2" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="form-group col-md-12">
                        <label for="" class="fs-4">Authorized Signature:<sup>2*</sup></label>
                        <input type="file" name="auth_sign_2" id="" class="form-control" placeholder=""
                            aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted fs-6">This value is required</small>
                    </div>
                </div>
